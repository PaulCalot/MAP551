...
\begin{figure}
	...
	\begin{figure*}
		\centering
		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/0_.png}
    	\end{subfigure}
		\centering  	
   		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/0_1.png}
    	\end{subfigure}
    	\centering   		

   		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/2_4.png}
    	\end{subfigure}
    	\centering   		
   		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/2_5.png}
    	\end{subfigure}
...
\begin{figure*}
		\centering
		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/with_conv_inf.png}
    	\end{subfigure}
		\centering  	
   		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/without_conv_inf.png}
    	\end{subfigure}
...
\begin{figure*}
		\centering
		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/with_conv_sup.png}
    	\end{subfigure}
		\centering  	
   		\begin{subfigure}{}
        	\includegraphics[width=8cm]{screen_capture_notebook/without_conv_sup.png}
    	\end{subfigure}
...
\begin{figure*}
		\centering
		\begin{subfigure}{}
        	\includegraphics[width=18cm]{screen_capture_notebook/Q233.png}
    	\end{subfigure}
