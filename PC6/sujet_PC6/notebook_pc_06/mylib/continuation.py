...
def natural_continuation_order_0(a_ini, a_end, na, yeq_ini, model, tol=1.e-8, nmax_newton=100):
...
def natural_continuation_order_1(a_ini, a_end, na, yeq_ini, model, tol=1.e-8, nmax_newton=100):
